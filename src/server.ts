      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            "2. All providers are disabled by default; nothing is searched until I opt in. Explain the trade-offs: Himalayas is a public remote-jobs endpoint enabled with JOBSCOUT_ENABLE_HIMALAYAS=true; We Work Remotely is a public RSS feed enabled with JOBSCOUT_ENABLE_WEWORKREMOTELY=true, filtered client-side since RSS has no keyword search; JobSpy scrapes job boards from my own machine, defaults to Indeed only, and widening JOBSPY_SITES is my decision and responsibility.",
